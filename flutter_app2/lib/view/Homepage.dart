...
import 'package:flutter_app2/view/Number1.dart';
        ...
        body: Padding(
          ...
          child: Center(
            child:Column(
              ...
              children: [
              buildText(text: "กรุณากรอกชื่อเล่น",size: 20.0,weight: FontWeight.bold,color: Colors.blue[900]),
  ...
  return Container(
    ...
    child: ElevatedButton(onPressed: (){
      ...
      if(nicknameControl.text ==""){
        ...
        Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder:(context) => NumberPage1()), (route) => false);
